...
@can('view_mitra')
    <x-nav.link route="admin.users.index" icon="fas fa-users" wire:navigate>Mitra</x-nav.link>
@endcan

@can('view_users')
    <x-nav.link route="admin.users.index" icon="fas fa-users" wire:navigate>Pegawai</x-nav.link>
@endcan

@can('view_klien')
    <x-nav.link route="admin.users.index" icon="fas fa-users" wire:navigate>Klien</x-nav.link>
@endcan

@if(can('view_warehouse') || can('view_warehouse_category'))
    <x-nav.group label="Warehouse" route="admin.settings" icon="fas fa-cogs">
        @can('view_warehouse')
            <x-nav.group-item route="admin.users.index" icon="far fa-circle" wire:navigate>Warehouse</x-nav.group-item>
        @endcan

        @can('view_warehouse_category')
            <x-nav.group-item route="admin.users.index" icon="far fa-circle" wire:navigate>Warehouse Category</x-nav.group-item>
        @endcan
    </x-nav.group>
@endif

@if(can('view_product') || can('view_product_category') || can('view_product_status'))
    <x-nav.group label="Product" route="admin.settings" icon="fas fa-cogs">
        @can('view_product')
            <x-nav.group-item route="admin.users.index" icon="far fa-circle" wire:navigate>Product</x-nav.group-item>
        @endcan

        @can('view_product_category')
            <x-nav.group-item route="admin.users.index" icon="far fa-circle" wire:navigate>Product Category</x-nav.group-item>
        @endcan

        @can('view_product_status')
            <x-nav.group-item route="admin.users.index" icon="far fa-circle" wire:navigate>Product Status</x-nav.group-item>
        @endcan
    </x-nav.group>
@endif
